    ...
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-30 h-screen w-[260px] 
          bg-gradient-to-b from-white to-gray-50 dark:from-[#050505] dark:to-[#0a0a0a] 
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 h-[68px] border-b border-gray-200 dark:border-white/[.08] transition-colors duration-300">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#22c55e] to-[#16a34a] flex items-center justify-center shadow-glow transition-all duration-300">
            ...
            <div>
              ...
              <span className="text-[10px] text-[#22c55e]/60 font-medium tracking-wider uppercase transition-colors duration-300">Monitor</span>
            </div>
          </div>
            ...
            return (
              <NavLink
                ...
                className={`slide-right stagger-${idx + 1} flex items-center gap-3 px-3 py-[10px] rounded-xl text-[13px] font-medium transition-all duration-300 group ${
                  isActive
                    ? 'bg-gradient-to-r from-[#22c55e]/20 to-[#16a34a]/20 text-gray-900 dark:text-white shadow-sm border border-[#22c55e]/30'
              ...
              >
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 ${
                  isActive ? 'bg-[#22c55e]/20 text-[#22c55e]' : 'text-gray-500 dark:text-slate-500 group-hover:text-gray-700 dark:group-hover:text-slate-300'
                }`}>
